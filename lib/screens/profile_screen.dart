        ...
        child: Column(
          children: [
            ...
            const CircleAvatar(
              ...
              child: Icon(LucideIcons.user, size: 40, color: Color(0xFF64748B)),
            ),
            ...
            const Text(
             ...
             _buildMenuItem(LucideIcons.logOut, "Logout", isDestructive: true),
          ],
        ),
      ),
    );
  ...
  Widget _buildStatCard(String label, String value) {
    return Expanded(
      child: Container(
        ...
        child: Column(
          children: [
            Text(value, style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Color(0xFFDC2626))),
